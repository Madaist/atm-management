...
public class AtmResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<AtmCashDepositResponse> handleConstraintViolation(ConstraintViolationException ex) {

        AtmCashDepositResponse exception = null;
        ...
        for (ConstraintViolation<?> constraintViolation : constraintViolations) {
            ...
            switch (message) {
                case MessageConstants.BILL_VALUE_ERROR_MESSAGE: {
                    exception = new AtmCashDepositResponse(
    ...
    public ResponseEntity<AtmCashDepositResponse> handleDuplicateBillValuesException(DuplicateBillValuesException ex) {

        AtmCashDepositResponse exception =  new AtmCashDepositResponse(ResponseConstants.DUPLICATE_BILL_VALUES.getStatus(),
    ...
    public ResponseEntity<AtmCashDepositResponse> handleRequestSizeExceededException(RequestSizeExceededException ex) {

        AtmCashDepositResponse exception = new AtmCashDepositResponse(ResponseConstants.REQUEST_SIZE_EXCEEDED.getStatus(),
    ...
    public ResponseEntity<AtmCashDepositResponse> handleAtmCapacityExceededException(AtmCapacityExceededException ex) {

        AtmCashDepositResponse exception = new AtmCashDepositResponse(ResponseConstants.ATM_CAPACITY_EXCEEDED.getStatus(),
